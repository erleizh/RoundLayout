...
) : RecyclerView(context, attrs, defStyleAttr), RoundView {

    @Suppress("LeakingThis")
    private var impl: RoundViewImpl = RoundViewImpl.createImpl(this, attrs)

    override fun dispatchDraw(canvas: Canvas) {
        impl.drawBefore(canvas)
        super.dispatchDraw(impl.replaceCanvas(canvas))
